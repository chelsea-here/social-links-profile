...
export default function Home() {
  return (
    <body className="flex flex-col justify-center items-center bg-off-black w-screen h-screen px-6">
      <main className="flex flex-col justify-center items-center w-full max-w-[24rem] h-full max-h-[38.1875rem] bg-dark-gray rounded-xl mx-auto">
